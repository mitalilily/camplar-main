    ...
    >
      ...
      <Paper
        ...
        sx={{
          ...
          boxShadow: '0 20px 50px rgba(0, 11, 55, 0.08)',
        }}
      >
        {/* Sidebar Progress */}
        <Box
            ...
            {steps.map((s) => {
              ...
              return (
                <Stack key={s.key} direction="row" spacing={1.8} alignItems="center">
                  ...
                  bgcolor: completed ? '#1C8B64' : active ? DE_BLUE : 'transparent',
                      border: completed
                        ? 'none'
                  ...
                  <Box>
                    <Typography
                      sx={{
                        fontSize: '0.88rem',
                        fontWeight: 800,
                        color: active ? DE_BLUE : completed ? '#1C8B64' : alpha(DE_BLUE, 0.4),
                      }}
                    >
                      {s.title}
                    </Typography>
