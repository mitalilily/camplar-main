...
const SKY_DARK = CAMPLAR_COLORS.primarySoft
        ...
        >
          <Box
            sx={{
              ...
              borderRadius: 5,
              background: `
                radial-gradient(circle at 12% 10%, ${alpha('#ffffff', 0.12)} 0%, transparent 34%),
                radial-gradient(circle at 88% 12%, ${alpha(ORANGE, 0.18)} 0%, transparent 28%),
                linear-gradient(135deg, ${SKY} 0%, ${SKY_DARK} 100%)
              `,
              position: 'relative',
              color: '#ffffff',
              border: `1px solid ${alpha(SKY, 0.12)}`,
              boxShadow: `0 22px 52px ${alpha(SKY, 0.22)}`,
              overflow: 'hidden',
            }}
          >
            <Stack spacing={2.6} sx={{ position: 'relative', zIndex: 1 }}>
              <Stack direction={{ xs: 'column', md: 'row' }} justifyContent="space-between" spacing={1.8}>
                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.4} alignItems={{ xs: 'flex-start', sm: 'center' }}>
                  ...
                  <Stack spacing={0.45} sx={{ maxWidth: 320 }}>
                    ...
                    >
                      {CAMPLAR_BRAND.name} command deck
                    </Typography>
                    <Typography
                      sx={{
                        fontSize: '1.5rem',
              ...
              <Stack spacing={2}>
                ...
                >
                  Ship smarter.
                  <br />
                  Run courier aggregation from a sharper Camplar workspace.
                </Typography>
                ...
                >
                  Reworked with Camplar navigation, cleaner density, and a stronger dashboard rhythm
                  so bookings, pickups, tracking, and billing feel like one connected flow.
                </Typography>
              </Stack>
              ...
              >
                {heroStats.map((item) => (
                  <Box
                    ...
                    boxShadow: `0 10px 22px ${alpha('#000000', 0.08)}`,
                  }}
                >
                    <Stack direction="row" spacing={1.2} alignItems="center">
                      ...
                      <Box>
                        ...
                        <Typography sx={{ fontSize: '0.82rem', color: alpha('#ffffff', 0.78) }}>
                          {item.label}
                        </Typography>
                      </Box>
                    </Stack>
