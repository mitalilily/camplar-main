...
const MUTED = '#5F7187'
const IVORY = '#F7F9FF'
const IVORY_SOFT = '#FFFFFF'
const MINT = '#FF5E14'
const TYPEFACE = '"Plus Jakarta Sans", "Montserrat", "Segoe UI", sans-serif'
...
const focusCards = [
  ...
  {
    title: 'Help Center',
    text: 'Support tickets, about content, and policy pages follow the same Camplar theme.',
  },
]
          ...
          <Box
            sx={{
              ...
              background: `
                ...
                linear-gradient(135deg, ${alpha('#FFFFFF', 0.96)} 0%, ${alpha('#F1F5FF', 0.96)} 58%, ${alpha('#FFF1EB', 0.98)} 100%)
              `,
              color: TEXT,
              position: 'relative',
            }}
              ...
              <Grid size={{ xs: 12, lg: 7 }}>
                <Stack spacing={2.2}>
                  ...
                  <Typography sx={{ maxWidth: 620, color: MUTED, lineHeight: 1.65 }}>
                    This preview skips sign-in so you can review the client UI shell, Camplar
