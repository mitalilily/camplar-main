...
export const ViewApiKeyModal = ({
  ...
  const handleDownloadCredentials = () => {
    const content = `Camplar API Credentials
Generated: ${new Date().toISOString()}
Key Name: ${apiKey.key_name}

WARNING: Keep these credentials secure and never share them publicly.
...
`
    ...
    link.href = url
    link.download = `camplar-api-credentials-${apiKey.key_name
      .replace(/\s+/g, '-')
