...
function SidebarResponsive(props) {
  ...
  const drawerBg = useColorModeValue('rgba(0,11,55,0.98)', 'rgba(0,11,55,0.98)')
  const activeBg = useColorModeValue('rgba(255,255,255,0.12)', 'rgba(143, 212, 255, 0.16)')
  const hoverBg = useColorModeValue('rgba(255,255,255,0.08)', 'rgba(255, 255, 255, 0.08)')
  const textColor = useColorModeValue('whiteAlpha.900', 'gray.100')
  const iconColor = useColorModeValue('whiteAlpha.700', 'gray.300')
  const activeTextColor = '#FFFFFF'
  const dividerColor = useColorModeValue('rgba(255,255,255,0.12)', 'rgba(143, 212, 255, 0.18)')
  const hamburgerSurface = useColorModeValue('rgba(255,255,255,0.16)', 'rgba(16, 24, 40, 0.82)')
  const hamburgerBorder = useColorModeValue('rgba(255,255,255,0.16)', 'rgba(255,255,255,0.12)')
  ...
  const brand = (
    <Box pt="26px" mb="12px">
        ...
        <Box as="img" src="/logo/camplar-wordmark.svg" alt="Camplar" h="42px" w="168px" objectFit="contain" />
    ...
    <Flex display={{ sm: 'flex', xl: 'none' }} ref={mainPanel} alignItems="center">
      ...
      >
        ...
        <DrawerContent
          ...
          boxShadow="0 28px 56px rgba(0,11,55,0.28)"
        >
