    ...
    global: (props) => ({
      body: {
        ...
        backgroundImage: mode(
          'radial-gradient(circle at 8% 6%, rgba(0,29,103,0.12) 0%, transparent 26%), radial-gradient(circle at 92% 4%, rgba(255,94,20,0.12) 0%, transparent 24%), linear-gradient(180deg, #fbfcff 0%, #f7f9ff 100%)',
