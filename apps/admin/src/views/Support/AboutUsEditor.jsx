...
const AboutUsEditor = () => {
  ...
  const handleLoadTemplate = () => {
    const templateHtml = `
      <h2>About Camplar</h2>
      <p><strong>Camplar</strong> is a modern shipping operations platform built for ecommerce sellers who want faster dispatch, lower courier costs, and a smoother post-purchase experience.</p>
      ...
      <h3>Contact</h3>
      <p><strong>Email:</strong> camplar11@gmail.com</p>
      <p><strong>Phone:</strong> 9714079405 / 9714079402</p>
      <p><strong>Address:</strong> C140 SoBo Centre South Bopal Ahmedabad - 380058 Gujarat India</p>
      <p><strong>Website:</strong> https://camplar-landing-page.onrender.com/</p>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updatePageMutation.mutateAsync({ title: 'About Us - Camplar', content })
      toast({
          ...
          <Box>
            ...
            <HStack spacing={3} mt={1}>
              <Text fontSize="sm" color="gray.500">
                Manage the Camplar story shown on the customer support screen.
              </Text>
              {page?.updated_at && (
