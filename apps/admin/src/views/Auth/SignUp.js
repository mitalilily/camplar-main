      ...
      >
        ...
        >
          <VStack align="flex-start" spacing={5} position="relative" zIndex="1">
            <Box as="img" src="/logo/camplar-wordmark.svg" alt="Camplar" h="62px" w="224px" objectFit="contain" />
            <Heading
            ...
            <Text color={textSecondary} fontSize="sm" maxW="360px" lineHeight="1.8">
              Create a Camplar workspace for teams that need cleaner shipment
            ...
            <VStack spacing={6} align="stretch">
              <Box>
                ...
                <Text mt={2} color={textSecondary} fontSize="sm" lineHeight="1.8">
                  Use this setup form to onboard your Camplar operations team.
                </Text>
              </Box>
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                ...
                <FormControl isRequired>
                  ...
                  <Input
                    placeholder="Camplar operations"
                    h="52px"
                    borderRadius="18px"
                    bg={inputBg}
                    borderColor={inputBorder}
