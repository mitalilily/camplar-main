...
import {
  DoorstepCourierScene,
} from "../../components/Brand/AnimatedCourierScene";
        ...
        >
          <VStack align="flex-start" spacing={4} position="relative" zIndex="1">
            ...
            <Text color={textSecondary} fontSize="sm" maxW="420px" lineHeight="1.8">
              Review orders, monitor activity, and manage operations from a cleaner
              Camplar admin workspace with stronger hierarchy and a more editorial
              rhythm.
            </Text>
          </VStack>
        </Flex>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Box>
                ...
                <Text mt={2} color={textSecondary} fontSize="sm" lineHeight="1.8">
                  Sign in with your Camplar administrator credentials.
                </Text>
              </Box>

              <HStack spacing={2} flexWrap="wrap">
                {["Fast access", "Softer cards", "Live ops focus"].map((pill) => (
                  <Box
                    key={pill}
                    px={3}
                    py={1.5}
